...
Public-mode startup, reverse-proxy requirements, Cookie/trusted-proxy rules, in-memory quota durability, and PR B prerequisites are documented in [`docs/public-playground-deployment-readiness.md`](../docs/public-playground-deployment-readiness.md). The generic single-host Nginx, systemd, and compile-only environment templates are in [`deploy/public-playground`](../deploy/public-playground/README.md). The data lifecycle is documented in [`docs/public-playground-privacy.md`](../docs/public-playground-privacy.md).
