...
Public-mode startup, reverse-proxy requirements, Cookie/trusted-proxy rules, in-memory quota durability, and PR B prerequisites are documented in [`docs/public-playground-deployment-readiness.md`](../docs/public-playground-deployment-readiness.md). The data lifecycle is documented in [`docs/public-playground-privacy.md`](../docs/public-playground-privacy.md).
